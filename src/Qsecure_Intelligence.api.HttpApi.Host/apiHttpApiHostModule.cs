...
using Qsecure_Intelligence.api.MultiTenancy;
...
public class apiHttpApiHostModule : AbpModule
{
            ...
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                options.FileSets.ReplaceEmbeddedByPhysical<apiDomainSharedModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}Qsecure_Intelligence.api.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<apiDomainModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}Qsecure_Intelligence.api.Domain"));
                options.FileSets.ReplaceEmbeddedByPhysical<apiApplicationContractsModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}Qsecure_Intelligence.api.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<apiApplicationModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}Qsecure_Intelligence.api.Application"));
            });
        }
    }
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "api API");
